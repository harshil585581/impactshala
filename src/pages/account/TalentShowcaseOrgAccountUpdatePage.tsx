...
const TALENT_TYPES = [
  'Art',                              'Cooking',                      'Aquatic Sports Competitions',
  'Music',                            'Gardening',                    'Mindfulness and Meditation',
  'Dance',                            'Craft',                        'Volunteer Recognition Events',
  'Sports',                           'Science',                      'Entrepreneurship Pitch Events',
  'DIY Project',                      'Health and Fitness Challenges', 'Skill Development Workshops',
  'Travel and Adventure Presentations','Martial Arts Demonstrations',  'Cultural Festivals',
  'Photography',                      'Technology Demonstrations',    'Others',
  'Gaming Tournaments',               'Historical Reenactments',
  'Astronomy Exhibits',               'Fashion Shows',
];
...
export default function TalentShowcaseOrgAccountUpdatePage() {
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/api/profile`, {
      ...
      .then((d) => {
        ...
        if (d.talent_types?.length) setTalentTypes(d.talent_types);
  ...
  function toggleTalent(type: string) {
    setTalentTypes((prev) =>
  ...
  async function handleSave() {
    ...
    const payloadByTab: Record<string, object> = {
      org:     { sector, talent_types: talentTypes, bio },
