...
function ScrollableDropdown({
  label, placeholder, value, options, open, onToggle, onSelect,
}: {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="relative">
        ...
        >
          <span className={value ? 'text-[#18191c]' : 'text-[#9199a3]'}>{value || placeholder}</span>
        ...
        {open && (
          <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-[#d6d6d6] rounded-[8px] shadow-lg z-20 overflow-hidden">
...
export default function EducatorAccountUpdatePage() {
          ...
          <div className="max-w-[960px] mx-auto px-4 sm:px-6 py-6 sm:py-8">
            ...
            {tab === 'profile' && (
              <div className="flex flex-col gap-5 sm:gap-6">
                ...
                {/* What can you teach */}
                <ScrollableDropdown
                  label="Select what you can teach"
                  placeholder="Select"
                  value={teachSubject}
              ...
              <div className="flex flex-col gap-5 sm:gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    <input type="email" placeholder="Email address" value={email}
                      onChange={(e) => setEmail(e.target.value)} className={`${inputCls} pl-11`} />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" placeholder="Languages you speak" value={languages}
                      onChange={(e) => setLanguages(e.target.value)} className={`${inputCls} pl-11`} />
                  </div>
                </div>
              </div>
            )}
