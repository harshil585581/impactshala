                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      <span
                        className={
                          educationLevel ? "text-[#18191c]" : "text-[#9199a3]"
                        }
                      >
                      ...
                      <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-[#e4e5e8] rounded-2xl shadow-lg z-10 overflow-hidden">
                        {EDUCATION_OPTIONS.map((opt) => (
                          <button
                            ...
                            className="w-full text-left px-4 py-3 text-sm text-[#18191c] hover:bg-[#fff6ed] hover:text-[#f77f00] transition-colors"
                          >
                            {opt}
                          </button>
                        ))}
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <label className="flex flex-col items-center gap-3 border-2 border-dashed border-[rgba(200,204,209,0.7)] bg-[rgba(241,242,244,0.4)] rounded-[6px] px-8 py-6 cursor-pointer hover:bg-[rgba(241,242,244,0.7)] transition-colors">
                    ...
                    <div className="text-center">
                      {resumeFileName ? (
                        <>
                          <p className="text-sm text-[#f77f00] font-medium truncate max-w-[200px]">
                            {resumeFileName}
                          </p>
                        ...
                        <>
                          <p className="text-sm text-[#18191c]">
                            <span className="font-medium">Browse File</span> or
                            drop here
                          </p>
                          <p className="text-xs text-[#5e6670] mt-1">
                  ...
                  {resumeFileName && (
                    <button
                      type="button"
                      className="text-xs text-[#f77f00] underline self-start"
                      onClick={async () => {
                        try {
                          ...
                          const res = await fetch(
                            `${import.meta.env.VITE_API_URL ?? "http://localhost:8000"}/api/profile/resume`,
                            {
                              headers: {
