  ...
  rejected: [
    {
      ...
      company: "Creative Tech Co.",
      location: "Remote",
      appliedAgo: "Applied 1 month Ago",
    },
  ],
};
...
export default function MyApplicationsPage() {
  ...
  const items = isOrg ? ORG_DATA[activeTab] : INDIVIDUAL_DATA[activeTab];
              ...
              items.map((item, idx) => (
                <div key={item.id}>
                  <div
                    ...
                    onClick={
                      isOrg
                        ? () => navigate(`/applications/detail/${item.id}`)
                        : undefined
                    }
                  >
                    {/* Left: details */}
                    ...
                    <div className="flex items-center gap-3 shrink-0 pt-1">
                      {isOrg && (
                        <span className="text-[#f77f00] font-medium text-sm sm:text-base whitespace-nowrap">
                          {(item as OrgPosting).applicantCount}{" "}
                          {(item as OrgPosting).applicantCount === 1
                            ? "Applicant"
                            : "Applicants"}
                        </span>
                      )}
