...
function OrgSectorLabel({ sector }: { sector?: string }) {
  ...
  return (
    <span className="inline-block text-xs font-semibold bg-[#fff8ee] text-[#ff9400] border border-[#ffd9a0] px-2.5 py-0.5 rounded-full">
      {label}
    </span>
  );
}
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-[14px] border border-[#f2f2f3] shadow-[0px_2px_8px_rgba(0,0,0,0.06)]">
              ...
              <div className="px-6 sm:px-16 py-6 flex flex-col">
                ...
                {/* Reach out */}
                <div>
                  <p className="text-[#18191c] text-sm font-semibold mb-3">Reach out to us for:</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  <div>
                    <p className="text-[#18191c] text-sm font-semibold mb-3">Service Offerings</p>
