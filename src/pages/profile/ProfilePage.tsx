...
const avatarMe = "https://www.figma.com/api/mcp/asset/3705c617-5e62-4578-acf8-8f5a2af9ff8f";
...
export default function ProfilePage() {
  ...
  const reachForTags = ['UI/UX Design', 'Flutter System', 'Product Strategy', 'Accessibility', 'Marketing/Go-to-Market'];
              ...
              <div className="px-6 pt-6 pb-0">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex flex-col gap-0.5 min-w-0">
                      <h1 className="text-[#18191c] text-xl font-bold leading-tight">
                        {profile ? `${profile.firstName} ${profile.lastName}` : 'Michael Anderson'}
                      </h1>
                      <p className="text-[#5e6670] text-sm">
                        Product Designer · Delhi Public School
                      </p>
                      <p className="text-[#9199a3] text-xs mt-0.5">
                        Passionate designer working in top-tier UX/UI and medical healthcare across, focusing on accessibility and inclusion.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0 flex-wrap justify-end">
                    {/* Email */}
                    <a href="#" className="text-[#9199a3] hover:text-[#ff9400] transition-colors" aria-label="Email">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" stroke="currentColor" strokeWidth="1.8"/><polyline points="22,6 12,13 2,6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>
                    </a>
                    {/* LinkedIn */}
                    <a href="#" className="text-[#9199a3] hover:text-[#0077b5] transition-colors" aria-label="LinkedIn">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z"/><circle cx="4" cy="4" r="2"/></svg>
                    </a>
                    {/* GitHub */}
                    <a href="#" className="text-[#9199a3] hover:text-[#18191c] transition-colors" aria-label="GitHub">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 00-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0020 4.77 5.07 5.07 0 0019.91 1S18.73.65 16 2.48a13.38 13.38 0 00-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 005 4.77a5.44 5.44 0 00-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 009 18.13V22"/></svg>
                    </a>
                    {/* Instagram */}
                    <a href="#" className="text-[#9199a3] hover:text-[#e1306c] transition-colors" aria-label="Instagram">
                    ...
                    {/* Twitter/X */}
                    <a href="#" className="text-[#9199a3] hover:text-[#18191c] transition-colors" aria-label="Twitter">
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
                    {/* Behance */}
                    <a href="#" className="text-[#9199a3] hover:text-[#1769ff] transition-colors" aria-label="Behance">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M22 7h-7V5h7v2zm1.726 10c-.442 1.297-2.029 3-5.101 3-3.074 0-5.564-1.729-5.564-5.675 0-3.91 2.325-5.92 5.466-5.92 3.082 0 4.964 1.782 5.375 4.426.078.506.109 1.188.095 2.14H15.97c.13 3.211 3.483 3.312 4.588 2.029H23.7zM19.34 13c-.104-1.336-1.02-1.893-1.97-1.893-1.04 0-1.856.63-2.01 1.893h3.98zM0 5h6.599c3.098 0 4.199 1.787 4.199 3.541 0 1.657-.895 2.652-2.099 3.151 1.441.35 2.739 1.426 2.739 3.338 0 2.531-1.978 3.97-5.098 3.97H0V5zm4.339 5.816c1.12 0 1.661-.465 1.661-1.278 0-.791-.51-1.197-1.575-1.197H3.35v2.475h.989zm.242 5.107c1.185 0 1.838-.526 1.838-1.489 0-.883-.577-1.408-1.855-1.408H3.35v2.897h1.231z"/></svg>
                    </a>
                    {/* YouTube */}
                    <a href="#" className="text-[#9199a3] hover:text-[#ff0000] transition-colors" aria-label="YouTube">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M22.54 6.42a2.78 2.78 0 00-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 00-1.95 1.96A29 29 0 001 12a29 29 0 00.46 5.58A2.78 2.78 0 003.41 19.6C5.12 20 12 20 12 20s6.88 0 8.59-.4a2.78 2.78 0 001.95-1.95A29 29 0 0023 12a29 29 0 00-.46-5.58zM9.75 15.02V8.98L15.5 12l-5.75 3.02z"/></svg>
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 mt-4 flex-wrap">
                  {isOwn ? (
                    <button
                      ...
                      className="flex items-center gap-1.5 h-[34px] px-4 border border-[#e4e5e8] text-[#18191c] text-xs font-medium rounded-full hover:border-[#ff9400] hover:text-[#ff9400] transition-colors"
                    >
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="none"><path d="M12 20h9M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                      Edit Profile
                    </button>
                  ) : (
                    <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <div className="w-[80px] h-[100px] bg-[#f3f5f7] rounded-[6px] border border-[#e4e5e8] flex items-center justify-center overflow-hidden">
                      <img src={postImg1} alt="Portfolio" className="w-full h-full object-cover opacity-60" />
                    </div>
                  </div>
                </div>
