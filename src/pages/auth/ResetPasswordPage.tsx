...
const primaryLogo = "https://www.figma.com/api/mcp/asset/e0e7b988-96c4-4b52-b3fa-190c7cd06977";
...
const inputCls =
  'w-full h-[48px] border border-[#e4e5e8] rounded-full px-4 pr-12 text-[#1e1e1e] text-sm sm:text-base placeholder-[#767f8c] focus:outline-none focus:border-[#ff9400] focus:ring-1 focus:ring-[#ff9400] transition-colors bg-white';
      ...
      <div className="flex-1 flex items-center justify-center px-5 sm:px-8 py-8 sm:py-12">
        <div className="flex flex-col gap-8 sm:gap-9 w-full max-w-[536px]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="flex items-center justify-center gap-3 w-full h-[56px] bg-[#ff9400] text-white text-sm sm:text-base font-semibold rounded-full hover:bg-[#e68500] transition-colors shadow-[0px_4px_12px_rgba(255,148,0,0.35)] mt-1"
            >
              Reset Password
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
