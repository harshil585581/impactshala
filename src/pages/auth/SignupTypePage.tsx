...
const iconIndividual = "https://www.figma.com/api/mcp/asset/a99eae6a-0252-4b53-92e3-118c2295ea10";
const iconOrganisation = "https://www.figma.com/api/mcp/asset/c1e0ba63-c48b-4f4f-9b35-2ad4e5b6f3e4";

export default function SignupTypePage() {
  const navigate = useNavigate();
  const [selected, setSelected] = useState<'individual' | 'organisation'>('individual');
    ...
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <div className="lg:hidden relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-between px-5 sm:px-8 py-5">
          ...
          <span className="text-white/80 text-xs sm:text-sm font-medium tracking-widest">STEP 01/03</span>
        </div>
      ...
      <div className="flex-1 bg-white flex flex-col">
        ...
        <div className="hidden lg:flex items-center justify-between px-10 py-5">
          ...
          <span className="text-[#bdbdbd] text-sm font-medium tracking-widest">STEP 01/03</span>
        </div>
          ...
          <div className="flex flex-col gap-3 sm:gap-4 w-full max-w-[440px]">
            ...
            >
              <div className="relative w-11 h-11 sm:w-[52px] sm:h-[52px] shrink-0">
                <img src={iconIndividual} alt="" className="absolute inset-0 w-full h-full" />
                <svg className="absolute inset-0 m-auto" width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <circle cx="12" cy="7" r="4" stroke="white" strokeWidth="2" />
                  <path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" stroke="white" strokeWidth="2" strokeLinecap="round" />
                </svg>
              </div>
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-[#1e1e1e] text-sm sm:text-base">Individual</p>
                <p className="text-[#5e6670] text-xs sm:text-sm mt-0.5 leading-snug">Personal account to manage all your activities.</p>
              </div>
              <div className="shrink-0 w-7 h-7 rounded-full bg-[#fff0de] flex items-center justify-center group-hover:bg-[#ff9400] transition-colors">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                  <path d="M5 12h14M13 6l6 6-6 6" stroke="#f77f00" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-white" />
                </svg>
              </div>
            </button>
            ...
            >
              <div className="relative w-11 h-11 sm:w-[52px] sm:h-[52px] shrink-0">
                <img src={iconOrganisation} alt="" className="absolute inset-0 w-full h-full" />
                <svg className="absolute inset-0 m-auto" width="18" height="18" viewBox="0 0 24 24" fill="none">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-[#1e1e1e] text-sm sm:text-base">Organisation</p>
                <p className="text-[#5e6670] text-xs sm:text-sm mt-0.5 leading-snug">Own or belong to a company, this is for you.</p>
              </div>
              <div className="shrink-0 w-7 h-7 rounded-full bg-[#f5f5f5] flex items-center justify-center group-hover:bg-[#ff9400] transition-colors">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                  <path d="M5 12h14M13 6l6 6-6 6" stroke="#aaa" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-white" />
                </svg>
              </div>
            </button>
          </div>
