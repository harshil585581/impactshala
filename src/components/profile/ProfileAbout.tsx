  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="min-w-0">
        ...
        <p className="text-[#18191c] text-sm font-medium mt-0.5 break-words">
          {value}
        </p>
      </div>
    </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            {profile.entrepreneurType && (
              <InfoRow
                ...
                value={
                  profile.entrepreneurType === "established"
        ...
        <Section title="Reach Out to Me For">
          <div className="flex flex-wrap gap-2">
            {profile.reachFor.map((tag) => (
              <span
                key={tag}
                className="bg-[#fff6ed] text-[#f77f00] text-sm font-medium px-3 py-1 rounded-full border border-[#ffeacc]"
              >
                {tag}
              </span>
            ))}
