  ...
  return (
    <div className="bg-white rounded-[14px] border border-[#f2f2f3] overflow-hidden shadow-[0px_2px_8px_rgba(0,0,0,0.06)]">
      ...
      <div className="px-5 sm:px-8 pb-5">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap mb-1">
            {profile.isOwnProfile ? (
              <>
                <button
                  onClick={onEditClick}
                  className="flex items-center gap-2 h-[40px] px-5 border border-[#f77f00] text-[#f77f00] text-sm font-semibold rounded-full hover:bg-[#fff6ed] transition-colors"
                >
                ...
                <button
                  onClick={() => {
                    ...
                    } else if (storedUser.user_type === 'organization' && storedUser.org_type === 'nonprofit') {
                ...
                <button
                  ...
                  className={`h-[40px] px-5 text-sm font-semibold rounded-full transition-colors ${
                    profile.isFollowing
                      ...
                      : "bg-[#f77f00] text-white hover:bg-[#e68500] shadow-[0px_4px_12px_rgba(255,148,0,0.3)]"
                  }`}
                >
        ...
        {/* Name & subtitle */}
        <div className="mt-3">
          <h1 className="text-[#18191c] text-xl sm:text-2xl font-bold leading-tight">
            {fullName}
          </h1>
          <p className="text-[#5e6670] text-sm sm:text-base mt-0.5">
            {subtitle}
          </p>
          {profile.location && (
