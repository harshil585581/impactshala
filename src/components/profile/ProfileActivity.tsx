...
const MOCK_POSTS = [
  {
    id: "1",
    content:
      "Excited to share my latest project on sustainable development! We've been working hard to create impactful solutions that make a difference.",
    time: "2h",
    reactions: 24,
    comments: 8,
  },
  {
    id: "2",
    content:
      "Great networking session at the Impact Summit today. Met some incredible change-makers who are truly transforming their communities.",
    time: "1d",
    reactions: 47,
    comments: 12,
  },
      ...
      {MOCK_POSTS.map((post) => (
        ...
        >
          ...
          <div className="flex items-center gap-4 mt-4 pt-3 border-t border-[#f2f2f3]">
            <button className="flex items-center gap-1.5 text-[#9199a3] text-sm hover:text-[#f77f00] transition-colors">
