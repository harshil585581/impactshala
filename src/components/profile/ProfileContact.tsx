...
const platformIcons: Record<string, React.ReactNode> = {
  ...
  GitHub: (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="#18191c">
      <path
  ...
  "Behance / Dribbble": (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="#1769ff">
      ...
      <div className="min-w-0 flex-1">
        ...
        {href ? (
          <a
            ...
            className="text-[#f77f00] text-sm font-medium hover:underline truncate block mt-0.5"
          >
            {value}
          </a>
        ) : (
          <p className="text-[#18191c] text-sm font-medium mt-0.5 truncate">
            {value}
          </p>
        )}
      </div>
...
export default function ProfileContact({ profile }: { profile: UserProfile }) {
  return (
    <div className="bg-white rounded-[14px] border border-[#f2f2f3] shadow-[0px_2px_8px_rgba(0,0,0,0.06)] px-5 sm:px-6 py-5 flex flex-col gap-5">
      <h3 className="text-[#18191c] text-base font-semibold border-b border-[#f2f2f3] pb-2">
        Contact
      </h3>
      ...
      <div className="flex flex-col gap-4">
        ...
        <ContactRow
          icon={
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path
                d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.1 8.12 19.79 19.79 0 01.07 4a2 2 0 012-2.18h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 9.91a16 16 0 006.18 6.18l1.27-.42a2 2 0 012.11.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"
                stroke="currentColor"
                strokeWidth="1.8"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      {profile.socialLinks.length > 0 && (
        <div className="flex flex-col gap-3 border-t border-[#f2f2f3] pt-4">
          <p className="text-[#9199a3] text-xs font-medium uppercase tracking-wide">
            Social Links
          </p>
